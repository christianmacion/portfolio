...
<video src="/proof/usep-lecture.mp4" poster="/proof/usep-lecture.jpg" title="USeP EGE 313 Manobo lecture — live presenter view (Sep 13 2024)" controls preload="metadata" playsinline style="width:100%; aspect-ratio:16/10; border-radius:8px; margin-block:var(--sp-4);">
  <track kind="captions" src="/proof/usep-lecture.vtt" srclang="en" label="English" default />
</video>
...
<video src="/proof/ai-workflow.mp4" poster="/proof/ai-workflow.jpg" title="AI workflow — ChatGPT-assisted slide-deck authoring for the same lecture" controls preload="metadata" playsinline style="width:100%; aspect-ratio:16/10; border-radius:8px; margin-block:var(--sp-4);">
  <track kind="captions" src="/proof/ai-workflow.vtt" srclang="en" label="English" default />
</video>
