...
export const INSTITUTIONS: Institution[] = [
  ...
  { id: 'iit-bombay',  city: 'Mumbai, IN',        country: 'IN', lat: 19.1334, lon:  72.9133, focus: 'q-fin', tier: 't1',
    researchDomains: ['asset-pricing', 'risk-management', 'financial-econometrics'],
    recentPapers: [] },
  { id: 'iit-delhi',   city: 'New Delhi, IN',     country: 'IN', lat: 28.5450, lon:  77.1926, focus: 'cs-ai', tier: 't1',
    researchDomains: ['computer-vision', 'deep-learning', 'reinforcement-learning'],
    recentPapers: [] },
  { id: 'iit-madras',  city: 'Chennai, IN',       country: 'IN', lat: 12.9916, lon:  80.2336, focus: 'cs-lg', tier: 't1',
    researchDomains: ['machine-learning', 'optimization', 'bayesian-methods'],
    recentPapers: [] },
  { id: 'iisc',        city: 'Bangalore, IN',     country: 'IN', lat: 13.0218, lon:  77.5671, focus: 'stat',  tier: 't1',
    researchDomains: ['statistical-theory', 'high-dimensional-statistics', 'bayesian-inference'],
    recentPapers: [] },
  { id: 'iit-kanpur',  city: 'Kanpur, IN',        country: 'IN', lat: 26.5123, lon:  80.2849, focus: 'stat',  tier: 't2',
    researchDomains: ['statistical-methodology', 'machine-learning-theory'],
    recentPapers: [] },
  { id: 'iit-kharagpur', city: 'Kharagpur, IN',   country: 'IN', lat: 22.3149, lon:  87.3105, focus: 'cs-lg', tier: 't2',
    researchDomains: ['machine-learning', 'data-mining'],
    recentPapers: [] },
  { id: 'hebrew-u',    city: 'Jerusalem, IL',     country: 'IL', lat: 31.7948, lon:  35.2417, focus: 'stat',  tier: 't1',
    researchDomains: ['statistical-theory', 'biostatistics', 'machine-learning'],
    recentPapers: [] },
  { id: 'technion',    city: 'Haifa, IL',         country: 'IL', lat: 32.7765, lon:  35.0231, focus: 'cs-ai', tier: 't1',
    researchDomains: ['computer-vision', 'robotics', 'deep-learning'],
    recentPapers: [] },
  { id: 'tau',         city: 'Tel Aviv, IL',      country: 'IL', lat: 32.1133, lon:  34.8044, focus: 'cs-lg', tier: 't1',
    researchDomains: ['machine-learning', 'natural-language-processing'],
    recentPapers: [] },
  { id: 'weizmann',    city: 'Rehovot, IL',       country: 'IL', lat: 31.9056, lon:  34.8086, focus: 'cs-lg', tier: 't1',
    researchDomains: ['machine-learning', 'applied-mathematics'],
    recentPapers: [] },
  { id: 'mbzuai',      city: 'Abu Dhabi, AE',     country: 'AE', lat: 24.4539, lon:  54.3773, focus: 'cs-ai', tier: 't1',
    researchDomains: ['computer-vision', 'natural-language-processing', 'machine-learning'],
    recentPapers: [] },
  { id: 'nyu-abu-dhabi', city: 'Abu Dhabi, AE',   country: 'AE', lat: 24.4500, lon:  54.3800, focus: 'cs-lg', tier: 't2',
    researchDomains: ['machine-learning', 'applied-statistics'],
    recentPapers: [] },
  { id: 'kaust',       city: 'Thuwal, SA',        country: 'SA', lat: 22.3089, lon:  39.1046, focus: 'cs-ai', tier: 't1',
    researchDomains: ['machine-learning', 'computational-biology', 'optimization'],
    recentPapers: [] },
  { id: 'kfupm',       city: 'Dhahran, SA',       country: 'SA', lat: 26.3027, lon:  50.1422, focus: 'cs-lg', tier: 't2',
    researchDomains: ['machine-learning', 'data-science'],
    recentPapers: [] },
  { id: 'koc',         city: 'Istanbul, TR',      country: 'TR', lat: 41.2033, lon:  29.0080, focus: 'stat',  tier: 't1',
    researchDomains: ['statistical-methodology', 'applied-statistics'],
    recentPapers: [] },
  { id: 'sabanci',     city: 'Istanbul, TR',      country: 'TR', lat: 40.8917, lon:  29.3814, focus: 'cs-lg', tier: 't2',
    researchDomains: ['machine-learning', 'pattern-recognition'],
    recentPapers: [] },
  { id: 'bilkent',     city: 'Ankara, TR',        country: 'TR', lat: 39.8667, lon:  32.8500, focus: 'cs-ai', tier: 't2',
    researchDomains: ['computer-vision', 'artificial-intelligence'],
    recentPapers: [] },
  { id: 'ntu-tw',      city: 'Taipei, TW',        country: 'TW', lat: 25.0173, lon: 121.5398, focus: 'cs-ai', tier: 't1',
    researchDomains: ['machine-learning', 'computer-vision', 'speech-processing'],
    recentPapers: [] },
  { id: 'nthu',        city: 'Hsinchu, TW',       country: 'TW', lat: 24.7957, lon: 120.9986, focus: 'cs-lg', tier: 't2',
    researchDomains: ['machine-learning', 'applied-mathematics'],
    recentPapers: [] },

  // === v7.9.2 EXPANSION — Africa ===
  { id: 'uct',         city: 'Cape Town, ZA',     country: 'ZA', lat: -33.9577, lon:  18.4612, focus: 'stat',  tier: 't1',
    researchDomains: ['statistical-theory', 'bayesian-inference', 'applied-statistics'],
    recentPapers: [] },
  { id: 'wits',        city: 'Johannesburg, ZA',  country: 'ZA', lat: -26.1907, lon:  28.0303, focus: 'stat',  tier: 't2',
    researchDomains: ['statistical-methodology', 'machine-learning'],
    recentPapers: [] },
  { id: 'stellenbosch', city: 'Stellenbosch, ZA', country: 'ZA', lat: -33.9321, lon:  18.8602, focus: 'q-fin', tier: 't2',
    researchDomains: ['risk-management', 'asset-pricing'],
    recentPapers: [] },
  { id: 'cairo-u',     city: 'Cairo, EG',         country: 'EG', lat: 30.0444, lon:  31.2357, focus: 'stat',  tier: 't2',
    researchDomains: ['statistical-methodology', 'biostatistics'],
    recentPapers: [] },
  { id: 'auc-cairo',   city: 'Cairo, EG',         country: 'EG', lat: 30.0444, lon:  31.2400, focus: 'cs-lg', tier: 't2',
    researchDomains: ['machine-learning', 'computer-science'],
    recentPapers: [] },
  { id: 'mohammed-v',  city: 'Rabat, MA',         country: 'MA', lat: 34.0209, lon:  -6.8416, focus: 'cs-ai', tier: 't2',
    researchDomains: ['artificial-intelligence', 'pattern-recognition'],
    recentPapers: [] },
  { id: 'ui-ibadan',   city: 'Ibadan, NG',        country: 'NG', lat:  7.3775, lon:   3.9470, focus: 'stat',  tier: 't3',
    researchDomains: ['applied-statistics', 'biostatistics'],
    recentPapers: [] },
  { id: 'uon',         city: 'Nairobi, KE',       country: 'KE', lat: -1.2801, lon:  36.8219, focus: 'stat',  tier: 't3',
    researchDomains: ['statistical-methodology', 'biostatistics'],
    recentPapers: [] },
  { id: 'ug',          city: 'Accra, GH',         country: 'GH', lat:  5.6506, lon:  -0.1960, focus: 'cs-lg', tier: 't3',
    researchDomains: ['machine-learning', 'data-mining'],
    recentPapers: [] },

  // === v7.9.2 EXPANSION — Oceania (AU depth + New Zealand) ===
  { id: 'auckland',    city: 'Auckland, NZ',      country: 'NZ', lat: -36.8485, lon: 174.7633, focus: 'cs-ai', tier: 't1',
    researchDomains: ['computer-vision', 'machine-learning'],
    recentPapers: [] },
  { id: 'canterbury-nz', city: 'Christchurch, NZ', country: 'NZ', lat: -43.5221, lon: 172.5794, focus: 'stat', tier: 't2',
    researchDomains: ['statistical-methodology', 'applied-statistics'],
    recentPapers: [] },
  { id: 'victoria-nz', city: 'Wellington, NZ',    country: 'NZ', lat: -41.2913, lon: 174.7772, focus: 'cs-lg', tier: 't2',
    researchDomains: ['machine-learning', 'graphics'],
    recentPapers: [] },
  { id: 'otago',       city: 'Dunedin, NZ',       country: 'NZ', lat: -45.8742, lon: 170.5036, focus: 'stat',  tier: 't3',
    researchDomains: ['biostatistics', 'applied-statistics'],
    recentPapers: [] },
  { id: 'anu',         city: 'Canberra, AU',      country: 'AU', lat: -35.2777, lon: 149.1185, focus: 'stat',  tier: 't1',
    researchDomains: ['statistical-theory', 'mathematical-statistics'],
    recentPapers: [] },
  { id: 'uq',          city: 'Brisbane, AU',      country: 'AU', lat: -27.4975, lon: 153.0133, focus: 'cs-lg', tier: 't1',
    researchDomains: ['machine-learning', 'computer-vision'],
    recentPapers: [] },
  { id: 'uwa',         city: 'Perth, AU',         country: 'AU', lat: -31.9523, lon: 115.8613, focus: 'cs-cl', tier: 't2',
    researchDomains: ['natural-language-processing', 'computational-linguistics'],
    recentPapers: [] },
  { id: 'adelaide',    city: 'Adelaide, AU',      country: 'AU', lat: -34.9076, lon: 138.5702, focus: 'cs-ai', tier: 't2',
    researchDomains: ['computer-vision', 'machine-learning'],
    recentPapers: [] },
  { id: 'mq',          city: 'Sydney, AU',        country: 'AU', lat: -33.7738, lon: 151.1117, focus: 'q-fin', tier: 't2',
    researchDomains: ['risk-management', 'asset-pricing'],
    recentPapers: [] },
  { id: 'wsu',         city: 'Sydney, AU',        country: 'AU', lat: -33.9210, lon: 150.9108, focus: 'cs-ai', tier: 't3',
    researchDomains: ['computer-vision', 'deep-learning'],
    recentPapers: [] },

  // === v7.9.2 EXPANSION — Caribbean ===
  { id: 'uwi-mona',    city: 'Kingston, JM',      country: 'JM', lat: 18.0047, lon: -76.7484, focus: 'stat',  tier: 't3',
    researchDomains: ['applied-statistics', 'biostatistics'],
    recentPapers: [] },
  { id: 'uwi-sta',     city: 'St Augustine, TT',  country: 'TT', lat: 10.6418, lon: -61.3995, focus: 'stat',  tier: 't3',
    researchDomains: ['statistical-methodology', 'applied-statistics'],
    recentPapers: [] },
  { id: 'utec',        city: 'San Juan, PR',      country: 'PR', lat: 18.3861, lon: -66.0587, focus: 'cs-lg', tier: 't3',
    researchDomains: ['machine-learning', 'data-science'],
    recentPapers: [] },

  // === v7.9.2 EXPANSION — Latin America ===
  { id: 'itam',        city: 'Mexico City, MX',   country: 'MX', lat: 19.3440, lon: -99.1970, focus: 'q-fin', tier: 't1',
    researchDomains: ['asset-pricing', 'risk-management', 'financial-econometrics'],
    recentPapers: [] },
  { id: 'unam',        city: 'Mexico City, MX',   country: 'MX', lat: 19.3240, lon: -99.1820, focus: 'stat',  tier: 't1',
    researchDomains: ['statistical-methodology', 'applied-statistics'],
    recentPapers: [] },
  { id: 'tec-mty',     city: 'Monterrey, MX',     country: 'MX', lat: 25.6516, lon: -100.2889, focus: 'cs-ai', tier: 't2',
    researchDomains: ['artificial-intelligence', 'robotics'],
    recentPapers: [] },
  { id: 'puc-rio',     city: 'Rio de Janeiro, BR', country: 'BR', lat: -22.9799, lon: -43.2337, focus: 'stat',  tier: 't1',
    researchDomains: ['statistical-methodology', 'bayesian-inference'],
    recentPapers: [] },
  { id: 'usp',         city: 'São Paulo, BR',     country: 'BR', lat: -23.5613, lon: -46.7307, focus: 'cs-lg', tier: 't1',
    researchDomains: ['machine-learning', 'computer-vision'],
    recentPapers: [] },
  { id: 'ita',         city: 'São José dos Campos, BR', country: 'BR', lat: -23.1791, lon: -45.8872, focus: 'cs-ai', tier: 't2',
    researchDomains: ['computer-vision', 'aerospace-engineering'],
    recentPapers: [] },
  { id: 'ufrj',        city: 'Rio de Janeiro, BR', country: 'BR', lat: -22.8628, lon: -43.2237, focus: 'stat',  tier: 't2',
    researchDomains: ['statistical-methodology', 'biostatistics'],
    recentPapers: [] },
  { id: 'uchile',      city: 'Santiago, CL',      country: 'CL', lat: -33.4569, lon: -70.6427, focus: 'stat',  tier: 't1',
    researchDomains: ['statistical-methodology', 'biostatistics'],
    recentPapers: [] },
  { id: 'puc-chile',   city: 'Santiago, CL',      country: 'CL', lat: -33.4087, lon: -70.6064, focus: 'cs-lg', tier: 't2',
    researchDomains: ['machine-learning', 'data-science'],
    recentPapers: [] },
  { id: 'uba',         city: 'Buenos Aires, AR',  country: 'AR', lat: -34.5997, lon: -58.3819, focus: 'stat',  tier: 't1',
    researchDomains: ['statistical-theory', 'applied-statistics'],
    recentPapers: [] },
  { id: 'itba',        city: 'Buenos Aires, AR',  country: 'AR', lat: -34.5530, lon: -58.4687, focus: 'q-fin', tier: 't2',
    researchDomains: ['risk-management', 'financial-engineering'],
    recentPapers: [] },
  { id: 'uandes',      city: 'Bogotá, CO',        country: 'CO', lat:  4.6010, lon: -74.0660, focus: 'stat',  tier: 't3',
    researchDomains: ['applied-statistics', 'biostatistics'],
    recentPapers: [] },

  // === v7.9.2 EXPANSION — Eastern Europe + Caucasus ===
  { id: 'warsaw',      city: 'Warsaw, PL',        country: 'PL', lat: 52.2298, lon:  21.0117, focus: 'stat',  tier: 't1',
    researchDomains: ['statistical-methodology', 'applied-statistics'],
    recentPapers: [] },
  { id: 'agh',         city: 'Kraków, PL',        country: 'PL', lat: 50.0680, lon:  19.9136, focus: 'cs-lg', tier: 't2',
    researchDomains: ['machine-learning', 'data-mining'],
    recentPapers: [] },
  { id: 'cvut',        city: 'Prague, CZ',        country: 'CZ', lat: 50.0875, lon:  14.4213, focus: 'cs-ai', tier: 't1',
    researchDomains: ['computer-vision', 'machine-learning'],
    recentPapers: [] },
  { id: 'cuni',        city: 'Prague, CZ',        country: 'CZ', lat: 50.0875, lon:  14.4244, focus: 'stat',  tier: 't2',
    researchDomains: ['statistical-methodology', 'applied-statistics'],
    recentPapers: [] },
  { id: 'elte',        city: 'Budapest, HU',      country: 'HU', lat: 47.4739, lon:  19.0598, focus: 'stat',  tier: 't2',
    researchDomains: ['statistical-methodology', 'applied-statistics'],
    recentPapers: [] },
  { id: 'bme',         city: 'Budapest, HU',      country: 'HU', lat: 47.4814, lon:  19.0554, focus: 'cs-lg', tier: 't2',
    researchDomains: ['machine-learning', 'data-mining'],
    recentPapers: [] },
  { id: 'skoltech',    city: 'Moscow, RU',        country: 'RU', lat: 55.6976, lon:  37.3601, focus: 'cs-lg', tier: 't1',
    researchDomains: ['machine-learning', 'applied-mathematics'],
    recentPapers: [] },
  { id: 'hse',         city: 'Moscow, RU',        country: 'RU', lat: 55.7728, lon:  37.6515, focus: 'cs-lg', tier: 't1',
    researchDomains: ['machine-learning', 'social-network-analysis'],
    recentPapers: [] },
  { id: 'kpi',         city: 'Kyiv, UA',          country: 'UA', lat: 50.4501, lon:  30.5234, focus: 'stat',  tier: 't2',
    researchDomains: ['statistical-methodology', 'applied-statistics'],
    recentPapers: [] },
  { id: 'tartu',       city: 'Tartu, EE',         country: 'EE', lat: 58.3780, lon:  26.7325, focus: 'cs-lg', tier: 't2',
    researchDomains: ['machine-learning', 'natural-language-processing'],
    recentPapers: [] },
];
